...
todo <- cbind(sc1[,2],sc2[,2],sc3[,2],nscr[,2],b[,2])
rownames(todo) <- c("Low", "Middle", "High")
colnames(todo) <- c("No deterministic seasonality", "No stochastic seasonality","No seasonality", "No risk","No seasonality and no risk")

stargazer(t(todo), summary = FALSE, title = "Median")

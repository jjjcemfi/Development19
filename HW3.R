...
ggplot(beta_plot, aes(beta)) + geom_histogram(aes(y = ..density..))
...
ggplot(phi_plot, aes(phi)) + geom_histogram(aes(y = ..density..))

mean(beta_plot[,1], na.rm=TRUE)
median(beta_plot[,1], na.rm=TRUE)

mean(phi_plot[,1], na.rm=TRUE)
